...
var withChunkExtractor = function withChunkExtractor(Component) {
  return function (props) {
    return React__default.createElement(Context.Consumer, null, function (extractor) {
  ...
  function loadable(loadableConstructor, options) {
    ...
    var InnerLoadable = /*#__PURE__*/function (_React$Component) {
      ...
      function InnerLoadable(props) {
        ...
        _this.promise = null;
        invariant$1(!props.__chunkExtractor || ctor.requireSync, 'SSR requires `@loadable/babel-plugin`, please install it'); // Server-side
    ...
    var Loadable = React__default.forwardRef(function (props, ref) {
      return React__default.createElement(EnhancedInnerLoadable, Object.assign({
        forwardedRef: ref
      }, props));
...
var createRoutes = function createRoutes(routes) {
  return /*#__PURE__*/createElement(BrowserRouter, null, /*#__PURE__*/createElement(Switch, null, routes.map(function (route) {
    var path = route.path,
    ...
    if (component) {
      var Page = loadable$2(component);
      return /*#__PURE__*/createElement(Route, {
        path: path,
        key: path
      }, /*#__PURE__*/createElement(Page, null));
    }
...
function App(props) {
  var name = props.name,
      routes = props.routes;
  var appNamespace = name ? "app-".concat(name) : "app";
...
var createApp = function createApp(config) {
  var rootElementId = config.rootElementId,
      routes = config.routes,
      name = config.name;
  ReactDOM.render( /*#__PURE__*/React__default.createElement(React__default.StrictMode, null, /*#__PURE__*/React__default.createElement(App, {
    routes: routes,
    name: name
